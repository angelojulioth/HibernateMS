...
class EventDispatchIntegrationTest {
    ...
    void setUp() {
        ...
        RegisterRequest registerReq = RegisterRequest.builder()
                ...
                .build();
        restTemplate.postForEntity(baseUrl + "/api/auth/register", registerReq, String.class);

        LoginResponse login = restTemplate.postForEntity(
                baseUrl + "/api/auth/login",
                new LoginRequest("eventuser", "eventpass123"),
    ...
    static class TestEventListener {
        ...
        public void onApplicationEvent(com.example.hibernatedemo.application.events.DomainEvent event) {
